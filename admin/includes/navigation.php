<!-- Navigation -->
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <li><a href="../index.php">Home</a></li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Rafael Sergio <b class="caret"></b></a>
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="post_dropdown" class="collapse">
                            <li>
                                <a href="#">Add novo post</a>
                            </li>
                            <li>
                                <a href="#">Ver todos os post</a>
                            </li>
                        </ul>
                    </li>
                        <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#user_dropdown"><i class="fa fa-fw fa-arrows-v"></i> Usuarios <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="user_dropdown" class="collapse">
                            <li>
                                <a href="#">Novo usuario</a>
                            </li>
                            <li>
                                <a href="#">Ver todos os usuarios</a>
                            </li>
                        </ul>
                    </li>
                    <li>
